...
def create_basic_agent(user_id: str, session_id: str) -> Agent:
    ...
    """
    system_prompt = """You are a technical analysis specialist. For a given stock, compute: 50-day SMA, 200-day SMA, RSI(14), MACD(12,26,9), and Bollinger Bands(20,2). Interpret each indicator as bullish, bearish, or neutral. If price data is insufficient for any indicator, note which indicators could not be computed and why. Return structured JSON with each indicator's value, interpretation, and any data availability notes."""
