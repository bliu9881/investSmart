...
def create_basic_agent(user_id: str, session_id: str) -> Agent:
    ...
    """
    system_prompt = """You are an analyst report aggregator. For a given stock, aggregate analyst recommendations. Produce: consensus (Strong Buy/Buy/Hold/Sell/Strong Sell), average_price_target, price_target_range (low/high), analyst_count, and limited_coverage (boolean, true if fewer than 3 reports). Return structured JSON."""
